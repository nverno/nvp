...
- [ ] completion missing a number of things, eg. warning, error, dynamic
...
- [ ] HAP - man/html/info docs or source code to find help?
...
*** HAP [0/2]
- [ ] company-backend
- [ ] function comments backend - like semantic/ia
