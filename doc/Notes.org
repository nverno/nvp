...
* Functions
** General [3/17]
- [ ] fix perl package install script / reply
- [ ] [[file:~/.emacs.d/site-lisp/nvp/modes/perl/nvp-perl.el::(defun%20nvp-perl-cpanm-install%20()][perl cpanm install]]
- [ ] [[file:~/.emacs.d/site-lisp/nvp/modes/shell/nvp-sh.el::(defvar%20nvp-sh-company-active-map][fix company-active-map in sh]]
...
- [ ] [[file:~/.emacs.d/site-lisp/nvp/modes/emacs-lisp/list_urls.sed::t%20loop][sed basic imenu for labels]]
- [ ] sed lookup help
