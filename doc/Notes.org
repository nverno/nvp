...
- Search: ripgrep / counsel+ivy / ag
- Toggle&Repeat: evil - see below
...
* Functions
** General [0/11]
- [ ] use simplified version of cc-defs c-point macro
...
- [ ] navigation by indentation for modes like yaml: pkg indent-tools

** Install [0/4]
- [ ] nvp-ext script functions / sudo are messed up
...
- [ ] compile with completing read for compiler switches
  Can leverage applicable parts of GNU help2man (perl)
