...
- profiling: how to profile with compiled init? profile-emacs.el won't work
...
- How to create concept index / tags in info files created from org-mode?
...
- Folding: is hideshow/hideif good enough? or something like origami.el?

** semantic stuff
This doesn't seem to be too actively maintained - haven't seen changes in past
few months.
- srecode
- ede
