;;; inf-perl.el --- Run Inferior Perl process -*- lexical-binding: t; -*-
...
(defcustom inf-perl-shell-program
  (expand-file-name "tools/psh.pl" perl-tools--dir)
...
(defcustom inf-perl-start-file
  (expand-file-name "tools/.pshrc" perl-tools--dir)
