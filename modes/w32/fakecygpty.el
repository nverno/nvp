...
(defvar fakecygpty-program
  (expand-file-name "fakecygpty/fakecygpty.exe" (getenv "DEVEL")))
(defvar fakecygpty-qkill-program
  (expand-file-name "fakecygpty/qkill.exe" (getenv "DEVEL")))
